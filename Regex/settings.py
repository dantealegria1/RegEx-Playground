...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'https://regex-playground.onrender.com']
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Keep WhiteNoise right after security middleware
